...
function gitStep(options) {
    return (_tree, context) => {
        ...
        try {
            ...
            execSync(`git commit -m "Refreshed package ${options.packageName}\n\n🤖 Generated with mark lib refresh"`, { cwd: options.packagePath, stdio: "pipe" });
 ...
 */
export function getRefreshResults() {
    return [...operations];
}
/**
 * Clear results (call before starting a new refresh)
 */
export function clearRefreshResults() {
    operations.length = 0;
}
/**
 * Main schematic factory
 */
export function libRefresh(options) {
    return (tree, context) => {
