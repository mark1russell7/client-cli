...
export const ConfigInitInputSchema: z.ZodObject<{
...
export const ConfigAddInputSchema: z.ZodObject<{
  feature: z.ZodString;
  path: z.ZodOptional<z.ZodString>;
}> = z.object({
  /** Feature to add */
...
export const ConfigRemoveInputSchema: z.ZodObject<{
  feature: z.ZodString;
  path: z.ZodOptional<z.ZodString>;
}> = z.object({
  /** Feature to remove */
...
export const ConfigGenerateInputSchema: z.ZodObject<{
  path: z.ZodOptional<z.ZodString>;
}> = z.object({
  /** Project path (defaults to cwd) */
  path: z.string().optional(),
...
export const ConfigValidateInputSchema: z.ZodObject<{
  path: z.ZodOptional<z.ZodString>;
}> = z.object({
  /** Project path (defaults to cwd) */
  path: z.string().optional(),
